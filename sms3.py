    ...
    for user_pref in user_preferences:
        ...
        if receive_messages:  # Sprawdź, czy użytkownik chce otrzymywać wiadomości
            for event in events:
                ...
                # Sprawdź, czy różnica czasu wynosi co najmniej 30 minut
                if time_difference >= timedelta(minutes=30):
                    ...
                    if current_time >= delivery_time:
                        ...
                        if title is not None and location is not None:
                            ...
                            message = f'Przypomnienie o wydarzeniu: {title_without_accents}, {location_without_accents}. Rozpocznie sie za {time_difference}.'
                        else:
                            message = f'Przypomnienie o wydarzeniu. Rozpocznie się za {time_difference}.'
                        print(message)
